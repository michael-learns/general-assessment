import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { toRef, isRef, hasInjectionContext, inject, getCurrentInstance, defineAsyncComponent, defineComponent, createElementBlock, ref, h, Suspense, Fragment, createApp, provide, shallowReactive, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, shallowRef, isReadonly, computed, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { o as klona, q as defuFn, t as parseURL, v as encodePath, w as decodePath, c as createError$1, x as hasProtocol, y as isScriptProtocol, m as joinURL, z as withQuery, A as sanitizeStatusCode, B as getContext, $ as $fetch$1, C as baseURL, D as createHooks, E as executeAsync, F as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-sN8Gc6Pj.mjs')
  },
  {
    name: "report-sessionId",
    path: "/report/:sessionId()",
    component: () => import('./_sessionId_-BsMUlW69.mjs')
  },
  {
    name: "assessment-sessionId",
    path: "/assessment/:sessionId()",
    component: () => import('./_sessionId_-Cqgrk0nF.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-CnueD9va.mjs').then((n) => n.i).then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DwSY2hpC.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BHtDoe21.mjs'));
...
export { _export_sfc as _, useAppConfig as a, useSeoMeta as b, useState as c, useNuxtApp as d, entry_default as default, useRoute as e, fetchDefaults as f, appConfig as g, useRouter as h, encodeRoutePath as i, useRuntimeConfig as j, nuxtLinkDefaults as k, asyncDataDefaults as l, createError as m, navigateTo as n, resolveRouteObject as r, useHead as u };
